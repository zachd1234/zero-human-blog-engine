...
public class PersonaService {
    ...
    public void generateAndSetupPersona(String topic) throws IOException, ParseException {
        try {
            ...
            // Debug: Print the generated image URL
            System.out.println("Generated image URL: " + this.imageUrl);
            
            if (this.imageUrl == null || this.imageUrl.isEmpty()) {
                throw new IllegalStateException("Failed to generate image URL");
            }
            
            // Create UnsplashImage object with correct constructor order (id, url, description)
            UnsplashImage personaImage = new UnsplashImage(
                "",               // Empty ID for AI-generated images
                this.imageUrl,   // The actual generated URL
                topic           // Description
            );
            
            // Update the WordPress page with the new image in the specific column
            mediaClient.updateColumnImage(
                318,                // page ID
                "318_74d069-a3",   // column ID from the HTML
                personaImage
            );
