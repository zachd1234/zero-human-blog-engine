...
public class PersonaService {
    ...
    public void generateAndSetupPersona(String topic) throws IOException, ParseException {
        ...
        System.out.println("Stereotypical Description: " + stereotypicalDescription);
    ...
    private void generateBasicPersona(String topic, String stereotypicalDescription) throws IOException {
        String personaPrompt = String.format(
            ...
            "Using this appearance and demographic as inspiration, but making the character deeper and more authentic, " +
            "please generate a detailed JSON response describing this character with the following fields:\n\n" +
            "1. name: Provide a natural, culturally appropriate full name that would fit someone matching the description " +
            "and background. The name should feel realistic and specific to their identity.\n\n" +
            "2. expertise: Write a concise, one-line summary in the first person describing their area of expertise, " +
            "written in a confident, relatable tone. Consider how their appearance and presentation influences their expertise.\n\n" +
            "3. biography: Craft an engaging and authentic 4-5 sentence life story in the first person that explains how they " +
            "became the person described. Include:\n" +
            ...
            "• How their appearance and presentation style evolved with their career\n" +
            ...
            "The character should feel like a real person who naturally evolved into the stereotype described, while being " +
            "relatable and perfectly aligned with the blog's theme.\n\n" +
