...
public class PersonaService {
    ...
    private String generateWritingTone(String topic) throws IOException {
        String prompt = String.format(
            ...
            "Background: %s\n" +
            "Appearance: %s\n\n" +
            "Describe their natural writing tone in 2-3 words (e.g., 'warmly authoritative' or 'scholarly yet accessible')." +
            "The tone should authentically reflect their personality and expertise in %s.",
            this.biography,
            this.imageUrl,
            topic
        );
