...
public class HomePage implements StaticPage {
    ...
    private void updateHeadingAndSubheading(BlogRequest request) throws IOException, ParseException {
        ...
        // Only replace the text content within the h1 and h2 tags
        ...
        String subheadingPattern = "(<h2 class=\"kt-adv-heading609_e56131-4a wp-block-kadence-advancedheading\" data-kb-block=\"kb-adv-heading609_e56131-4a\">).*?(</h2>)";
        
        String updatedContent = currentContent
            .replaceFirst(headingPattern, "$1" + heading + "$2")
            .replaceFirst(subheadingPattern, "$1" + subheading + "$2");
