...
public class HomePage implements StaticPage {
    ...
    private void updateHeadingAndSubheading(BlogRequest request) throws IOException, ParseException {
        ...
        System.out.println("\n=== Updating WordPress ===");
        String url = WordPressConfig.BASE_URL + "pages/" + getPageId() + "?context=edit";
        HttpGet getRequest = new HttpGet(URI.create(url));
        blockClient.setAuthHeader(getRequest);
        ...
        try (CloseableHttpResponse response = blockClient.getHttpClient().execute(getRequest)) {
            ...
            // Update heading with complete block structure
            ...
            // Update subheading with complete block structure
            ...
            blockClient.setAuthHeader(updateRequest);
