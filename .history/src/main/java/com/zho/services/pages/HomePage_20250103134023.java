...
public class HomePage implements StaticPage {
    ...
    public HomePage(WordPressBlockClient blockClient, OpenAIClient openAIClient, WordPressMediaClient mediaClient) {
    ...
    public void updateStaticContent(BlogRequest request, List<UnsplashImage> images) throws IOException, ParseException {
        ...
        // 1. Create the new update method (e.g., updateNewSection)
        // 2. Update getRequiredImageCount() to return the new total
        // 3. Use the appropriate image from the images list parameter
    }
    ...
    private void updateHeadingAndSubheading(BlogRequest request) throws IOException, ParseException {
        ...
        // Only replace the text content within the h1 tag for heading
        String headingPattern = "(<h1 class=\"kt-adv-heading609_a8d80a-ca wp-block-kadence-advancedheading\" data-kb-block=\"kb-adv-heading609_a8d80a-ca\">).*?(</h1>)";
        ...
        String updatedContent = currentContent
            .replaceFirst(headingPattern, "$1" + heading + "$2")
    ...
    public static void main(String[] args) {
        try {
            ...
            HomePage homePage = new HomePage(blockClient, openAIClient, mediaClient);
