...
public class AboutPage implements StaticPage {
    ...
    private void updateStoryAndMission(String story, String mission) throws IOException, ParseException {
        ...
        // Update story using Kadence heading block
        String storyPattern = "<!-- wp:paragraph \\{\"className\":\"story\"\\} -->[\\s\\S]*?<!-- /wp:paragraph -->";
        String newStory = "<!-- wp:paragraph {\"className\":\"story\"} -->\n" +
                         "<p class=\"story\">" + story + "</p>\n" +
                         "<!-- /wp:paragraph -->";
        
        // Update mission using Kadence heading block
        String missionPattern = "<!-- wp:paragraph \\{\"className\":\"mission\"\\} -->[\\s\\S]*?<!-- /wp:paragraph -->";
        String newMission = "<!-- wp:paragraph {\"className\":\"mission\"} -->\n" +
