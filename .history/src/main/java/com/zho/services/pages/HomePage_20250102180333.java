...
public class HomePage implements StaticPage {
    ...
    private void updateHeadingAndSubheading(BlogRequest request) throws IOException, ParseException {
        ...
        // Simplified subheading properties
        JSONObject subheadingProps = new JSONObject()
            .put("uniqueID", "609_e56131-4a")
            .put("align", "center")
            .put("color", "#ffffff")
            .put("htmlTag", "h2")
            .put("enableTextShadow", true)
            .put("textShadow", new JSONArray().put(new JSONObject()
                .put("vOffset", 3)
                .put("color", "palette2")
                .put("enable", false)
                .put("blur", 1)
            ...
            .put("markBorder", "")
            .put("markBorderStyles", new JSONArray().put(new JSONObject()
                .put("top", new Object[]{null, "", ""})
                .put("right", new Object[]{null, "", ""})
                .put("bottom", new Object[]{null, "", ""})
                .put("left", new Object[]{null, "", ""})
                .put("unit", "px")))
            .put("tabletMarkBorderStyles", new JSONArray().put(new JSONObject()
                .put("top", new Object[]{null, "", ""})
                .put("right", new Object[]{null, "", ""})
                .put("bottom", new Object[]{null, "", ""})
                .put("left", new Object[]{null, "", ""})
                .put("unit", "px")))
            .put("mobileMarkBorderStyles", new JSONArray().put(new JSONObject()
                .put("top", new Object[]{null, "", ""})
                .put("right", new Object[]{null, "", ""})
                .put("bottom", new Object[]{null, "", ""})
                .put("left", new Object[]{null, "", ""})
