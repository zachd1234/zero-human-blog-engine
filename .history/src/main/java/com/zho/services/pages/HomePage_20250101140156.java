...
public class HomePage implements StaticPage {
    ...
    private void updateHeadingAndSubheading(BlogRequest request) throws IOException, ParseException {
        ...
        JSONObject headingProps = new JSONObject()
            ...
            .put("fontSize", new int[]{60, null, 40})
            .put("fontHeight", new int[]{68, null, 48})
            .put("fontHeightType", "px")
            .put("markBorder", "")
            .put("markBorderStyles", new JSONArray()
                .put(new JSONObject()
                    .put("top", new JSONArray().put(null).put("").put(""))
                    .put("right", new JSONArray().put(null).put("").put(""))
                    .put("bottom", new JSONArray().put(null).put("").put(""))
                    .put("left", new JSONArray().put(null).put("").put(""))
                    .put("unit", "px")))
