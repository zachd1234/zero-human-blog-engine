...
public class AboutPage implements StaticPage {
    ...
    public static void main(String[] args) {
        try {
            ...
            aboutPage.updateStaticContent(testRequest, Arrays.asList(new UnsplashImage("https://images.unsplash.com/photo-1518791841217-8cc77978b23a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "tennis player")));
