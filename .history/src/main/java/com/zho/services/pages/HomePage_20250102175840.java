...
public class HomePage implements StaticPage {
    ...
    private String generateHeading(BlogRequest request) throws IOException {
        ...
        return openAIClient.callOpenAI(headingPrompt, 0.9);
    }

    private String generateSubheading(BlogRequest request) throws IOException {
        String heading = generateHeading(request);  // Get the heading first
        ...
        return openAIClient.callOpenAI(subheadingPrompt, 0.9);
    }
