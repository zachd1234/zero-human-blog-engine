    ...
    public static void main(String[] args) {
        try {
            ...
            BlogRequest[] testRequests = {
                new BlogRequest("Tennis Coaching", "Learn tennis from professional coaches"),
                new BlogRequest("Discounted Cash Flow Analysis", "Understanding financial valuation methods"),
                new BlogRequest("Mediterranean Cooking", "Authentic Mediterranean recipes and techniques"),
                new BlogRequest("Machine Learning for Healthcare", "AI applications in medical diagnosis")
            };
            ...
            for (BlogRequest request : testRequests) {
                System.out.println("\n=== Testing static content generation for: " + request.getTopic() + " ===");
                try {
                    ...
                    // Populate pages
                    service.populateStaticPages(request);
                    
                    System.out.println("✓ Success: Static pages populated for " + request.getTopic());
