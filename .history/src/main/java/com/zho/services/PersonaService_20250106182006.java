...
public class PersonaService {
    ...
    public static void main(String[] args) {
        try {
            ...
            WordPressClient wpClient = new WordPressClient("your-wordpress-url", "your-username", "your-application-password");
            
            // Create PersonaService instance
            PersonaService personaService = new PersonaService(openAIClient, wpClient);
            
            // Test with a sample topic
            String testTopic = "tennis tips for beginners";
