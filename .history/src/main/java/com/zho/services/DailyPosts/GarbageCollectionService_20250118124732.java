...
public class GarbageCollectionService {
    ...
    public static void main(String[] args) {
        try {
            ...
            String wpUrl = System.getenv("WP_URL");
            String wpToken = System.getenv("WP_TOKEN");
            
            if (wpUrl == null || wpToken == null) {
                throw new IllegalArgumentException("Missing required environment variables WP_URL or WP_TOKEN");
            }
            
            // Create WordPress client
            WordPressPostClient wpClient = new WordPressPostClient(wpUrl, wpToken);
