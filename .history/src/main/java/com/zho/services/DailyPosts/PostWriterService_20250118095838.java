...
public class PostWriterService {
    ...
    private List<OutlineSection> parseSectionTitles(String outline) {
        ...
        for (String line : outline.split("\n")) {
            ...
            } else if (line.matches("^\\d+\\.\\d+\\s+.*")) {  // Changed pattern to match "1.1", "1.2" etc.
                // Bullet point - make sure we have a current section
        ...
        for (OutlineSection section : sections) {
            ...
            System.out.println("Type: " + (section.isH3 ? "H3" : "H2"));
            System.out.println("Points (" + section.points.size() + "):");
    ...
    private String analyzeAudience(String keyword) throws IOException {
        String prompt = String.format(
            "Given the keyword '%s':\n\n" +
            "1. Who is the target audience searching for this?\n" +
            "2. What specific problem or question are they trying to solve?\n" +
            "3. What is their level of expertise on this topic?\n\n" +
    ...
    public String generateOutline(String keyword) throws IOException {
        ...
        String prompt = String.format(
            ...
            "Some of the target audience may fit this analysis: %s\n" +
    ...
    public String generateSection(OutlineSection section) throws IOException {
        ...
        String prompt = String.format(
            ...
            "-Use lists, short paragraphs and other formatting to make the section more readable\n" +
