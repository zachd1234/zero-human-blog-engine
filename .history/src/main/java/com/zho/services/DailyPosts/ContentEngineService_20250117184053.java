...
import com.zho.services.KeywordResearchService;
import com.zho.services.DatabaseService;
import com.zho.models.BlogRequest;
import com.zho.models.KeywordAnalysis;
...
public class ContentEngineService {
    ...
    public void startContentEngine(String blogTopic, String blogDescription) {
        try {
            // 1. Perform keyword research
            BlogRequest request = new BlogRequest(blogTopic, blogDescription);
