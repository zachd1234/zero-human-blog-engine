...
public class KeywordResearchService {
        ...
        try {
            ...
            for (GenerateKeywordIdeaResult keyword : allKeywords) {
                if (keyword.getKeywordIdeaMetrics().getCompetitionIndex() < 30) {
                    ...
                    KeywordAnalysis analysis = analyzeKeywordWithAI(keyword, blogRequest);
    ...
    private KeywordAnalysis analyzeKeywordWithAI(GenerateKeywordIdeaResult keyword, BlogRequest blogRequest) {
        String prompt = String.format("""
            Analyze this keyword: '%s'
            
            Rate from the keyword from 1-10 as a candidate for our early stage blog about %s.
            Consider:
            1. What is the user looking for?
            2. Can a blog post satisfy this search intent?
            3. If the user is looking for a specific website or location, our digital blog can't match search intent.
            4. Is this a genuine informational query we can address?
            5. Do you think this a keyword is too competitive for our early stage blog?  
        ...
        System.out.println("AI Analysis for keyword: " + keyword.getText() + " is: " + analysis);
    ...
    public static void main(String[] args) {
        ...
        BlogRequest request = new BlogRequest("plumbing blog","A blog about plumbing");
