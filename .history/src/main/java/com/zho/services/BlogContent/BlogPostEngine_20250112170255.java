...
public class BlogPostEngine {
    ...
    public String generateOutline(String keyword) throws IOException {
        String prompt = String.format(
            ...
            "Format requirements:\n" +
            "1. Use '## ' prefix for main sections (e.g., '## 1. Introduction')\n" +
            "2. Number sections sequentially (1, 2, 3, etc.)\n" +
            "3. Include 4-6 main sections\n" +
            "4. Optional subsections can use single '#' prefix\n" +
