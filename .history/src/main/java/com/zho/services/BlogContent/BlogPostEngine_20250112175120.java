...
public class BlogPostEngine {
    ...
    public String createNewBlogPost(String keyword) throws IOException {
        ...
        String fullPost = generateFullContent(currentOutline);
    ...
    public String generateFullContent(String outline) throws IOException {
        String prompt = String.format("now given outline, write a 1,500 word (minimum) article using the outline above, " +
                        "taking into account the audience, topic, and a neutral confident, knowledgeable,clear tone." +
