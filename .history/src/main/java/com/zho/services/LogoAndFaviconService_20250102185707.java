    ...
    public static void main(String[] args) {
        try {
            ...
            BlogRequest[] testRequests = {
                new BlogRequest("Advanced Quantum Computing", "A blog about quantum physics and computing"),
                new BlogRequest("Mediterranean Cooking Tips", "Authentic Mediterranean recipes and techniques"),
                new BlogRequest("Professional Dog Training", "Expert tips for training your dog"),
                new BlogRequest("Machine Learning for Healthcare", "AI applications in medical diagnosis"),
                new BlogRequest("Urban Gardening in Small Spaces", "Growing plants in apartments")
            };
