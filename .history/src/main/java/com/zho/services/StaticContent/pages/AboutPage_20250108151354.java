...
public class AboutPage implements StaticPage {
    ...
    private String generateStory(Persona persona) throws IOException {
        return String.format(
            "Hi! My name is %s, and I'm glad you are here.",
            persona.getName()
        );
    }
    ...
    private void updateMission(String intro, String mission) throws IOException, ParseException {
        ...
        String headingPattern = "<!-- wp:heading \\{\"textAlign\":\"center\",\"uniqueID\":\"318_mission\"\\} -->\n<h2[^>]*>[^<]*</h2>\n<!-- /wp:heading -->";
        String newHeading = "<!-- wp:heading {\"textAlign\":\"center\",\"uniqueID\":\"318_mission\"} -->\n" +
                          "<h2 class=\"wp-block-heading has-text-align-center\">Our Mission</h2>\n" +
                          "<!-- /wp:heading -->";
        
        // Update mission paragraph
        String paragraphPattern = "<!-- wp:paragraph -->\n<p class=\"\">[^<]*</p>\n<!-- /wp:paragraph -->";
        String newParagraph = "<!-- wp:paragraph -->\n<p class=\"\">" + mission + "</p>\n<!-- /wp:paragraph -->";
        
        String updatedContent = currentContent
            .replaceFirst(headingPattern, newHeading)
            .replaceFirst(paragraphPattern, newParagraph);
