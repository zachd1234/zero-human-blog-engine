...
public class KeywordResearchService {
    ...
    private KeywordAnalysis analyzeKeywordWithAI(GenerateKeywordIdeaResult keyword, String blogTopic) {
        String prompt = String.format("""
            ...
            1. Competition Rating (1-10):
               ...
               - 1 = extremely competitive, 10 = very easy to rank for
            ...
            3. Relevance Rating:
               - Rate 0-3 if query is irrelevant (location-specific, looking for a specific website, ect)
               - Rate 10 if query is relevant for a blog post
    ...
    private double parseAIResponse(String analysis) {
        try {
            ...
            // Only if relevance is 10, otherwise return 0
            if (relevance < 10) {
                return 0.0;
            }
    ...
    public static void main(String[] args) {
        ...
        BlogRequest request = new BlogRequest("blog about roleplay AI chatbots","A blog about roleplay, fantasy, and romantic AI chatbots");
