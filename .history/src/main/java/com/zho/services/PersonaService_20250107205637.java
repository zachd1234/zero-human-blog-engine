...
public class PersonaService {
    ...
    private String generateStereotypicalDescription(String topic) throws IOException {
        String stereotypePrompt = String.format(
            ...
            "Make it read like a natural description, avoiding phrases like 'exuding' or 'reflecting their expertise'. " +
            "Include specific, tangible details that create a vivid mental image.\n\n" +
            "Example style: \"A passionate man in his early 40s, with a lean, athletic build and sun-kissed skin " +
