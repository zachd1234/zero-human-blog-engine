...
public class DatabaseService {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Add some test topics (you'll need to do this manually in MySQL for now)
            System.out.println("\nPlease add some test topics to the database...");
            System.out.println("You can use this SQL:");
            System.out.println("INSERT INTO topics (topic) VALUES ('Tennis');");
            System.out.println("INSERT INTO topics (topic) VALUES ('Cooking');");
            System.out.println("INSERT INTO topics (topic) VALUES ('Programming');");
