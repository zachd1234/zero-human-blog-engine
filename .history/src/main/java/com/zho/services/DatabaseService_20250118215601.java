...
public class DatabaseService {
    ...
    public static Connection getConnection() {
        try {
            ...
            try {
                System.out.println("2. Attempting to load MySQL driver...");
                Class.forName("com.mysql.cj.jdbc.Driver");
                System.out.println("3. ✓ MySQL driver loaded successfully!");
            } catch (ClassNotFoundException e) {
                System.out.println("3. ✗ Failed to load MySQL driver: " + e.getMessage());
    ...
    public boolean isBlogActive() throws SQLException {
        String sql = "SELECT is_active FROM blog_status LIMIT 1";
        try (Connection conn = getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
