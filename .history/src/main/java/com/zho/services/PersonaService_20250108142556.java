...
public class PersonaService {
    ...
    private String generateWritingTone(String topic) throws IOException {
        String prompt = String.format(
            "For a blog about %s, describe the ideal writing tone in 2-3 words (e.g., 'professional yet approachable' or 'enthusiastic and technical')",
            topic
        );
    ...
    private String generateSystemPrompt(String topic) throws IOException {
        String prompt = String.format(
            "Create a system prompt for an AI that will write blog posts about %s. The AI should write in the voice of an expert in this field.",
            topic
        );
        return openAIClient.callGPT4(prompt);
    }
