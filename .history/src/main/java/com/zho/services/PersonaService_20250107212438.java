...
import com.zho.api.wordpress.UnsplashImage;
...
public class PersonaService {
    ...
    public void generateAndSetupPersona(String topic) throws IOException, ParseException, SQLException {
        ...
        UnsplashImage personaImage = new UnsplashImage(
            ...
            "Generated persona image for " + topic
        );
        
        // Update the WordPress page with the new image
        WordPressMediaClient mediaClient = new WordPressMediaClient();
        mediaClient.updateSimpleImage(318, personaImage);  // 318 is the page ID from your HTML
