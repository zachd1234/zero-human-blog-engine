...
import com.google.ads.googleads.v18.services.KeywordPlanIdeaServiceClient.GenerateKeywordIdeaResult;
...
public class KeywordResearchService {
    ...
    public List<KeywordIdea> getLongTailKeywords(BlogRequest blogRequest, int keywordCount) {
        try {
            ...
            List<KeywordIdea> keywords = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        try {
            List<KeywordIdea> keywords = service.getLongTailKeywords(request, 1000);
            ...
            keywords.stream()
                ...
                .forEach(keyword -> System.out.printf("%-30s | %14d | %13.2f%% | %9.2f%% | %-11s | %d%n",
                    ...
                    keyword.getKeywordIdeaMetrics().getThreeMonthChangePercent(),
                    keyword.getKeywordIdeaMetrics().getYearOverYearChange(),
                    keyword.getCompetition().toString(),
