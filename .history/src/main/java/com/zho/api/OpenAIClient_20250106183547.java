...
public class OpenAIClient {
    ...
    public String callGPT4(String prompt) throws IOException {
        JSONObject json = new JSONObject();
        json.put("model", "gpt-4-0314");  // Using GPT-4 version 0
        ...
        // Use the same endpoint as GPT-3.5 as they both use the chat completions API
    ...
    public static void main(String[] args) {
        try {
            ...
            String response1 = client.callGPT4(simplePrompt, 0.7);
