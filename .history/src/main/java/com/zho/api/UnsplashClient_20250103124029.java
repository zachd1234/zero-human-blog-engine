...
public class UnsplashClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<UnsplashImage> singleImage = client.searchImages("coffee", 1);
            ...
            List<UnsplashImage> multipleImages = client.searchImages("nature landscape", 3);
            ...
            List<UnsplashImage> specificImages = client.searchImages("vintage typewriter desk", 2);
    ...
    private static void printImageDetails(List<UnsplashImage> images) {
        for (int i = 0; i < images.size(); i++) {
            UnsplashImage image = images.get(i);
