...
public class UnsplashClient {
    ...
    public List<UnsplashImage> searchImages(String query) throws IOException, ParseException {
        System.out.println("Searching Unsplash for: " + query);
        
        String encodedQuery = URLEncoder.encode(query, StandardCharsets.UTF_8);
        String url = String.format("%s/search/photos?query=%s&per_page=10&orientation=landscape", API_URL, encodedQuery);
