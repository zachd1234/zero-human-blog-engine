...
import org.apache.hc.core5.http.HttpUriRequest;
...
public class WordPressPostClient extends BaseWordPressClient {
    ...
    public String publishPost(BlogPost blogPost) {
    ...
    private String makeRequest(String method, String endpoint, Map<String, Object> data) throws IOException {
        ...
        ((HttpPost) request).setEntity(new StringEntity(jsonData.toString(), StandardCharsets.UTF_8));
        request.setHeader("Content-Type", "application/json");
