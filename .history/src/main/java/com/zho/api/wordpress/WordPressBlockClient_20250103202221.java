...
public class WordPressBlockClient extends BaseWordPressClient {
    ...
    public void updatePageSection(int pageId, String sectionId, String newContent) throws IOException, ParseException {
        ...
        try (CloseableHttpResponse response = httpClient.execute(getRequest)) {
            ...
            System.out.println("\n=== DEBUG INFO ===");
            System.out.println("Content to search: " + currentContent);
            
            // Look for the exact Features section
            String targetPattern = "<!-- wp:group \\{\"metadata\":\\{\"name\":\"Features\"\\},\"className\":\"nfd-container nfd-p-lg nfd-theme-darker nfd-bg-surface nfd-wb-features__features-4 is-style-nfd-theme-darker\"[\\s\\S]*?<!-- /wp:group -->";
            ...
            if (matcher.find()) {
                System.out.println("Found Features section with Explore Topics");
                String wrappedNewContent = "<!-- wp:group {\"metadata\":{\"name\":\"Features\"}," +
                    "\"className\":\"nfd-container nfd-p-lg nfd-theme-darker nfd-bg-surface nfd-wb-features__features-4 is-style-nfd-theme-darker\"," +
                    "\"layout\":{\"type\":\"constrained\"},\"nfdGroupTheme\":\"\",\"nfdGroupEffect\":\"dots\"} -->\n" +
                ...
                System.out.println("Could not find Features section with Explore Topics");
            }
